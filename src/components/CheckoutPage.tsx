                    ...
                    <form onSubmit={handlePurchase} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <button
                                ...
                                className={cn(
                                    "w-full h-[60px] text-white bg-[#e11d24] rounded-2xl font-black text-2xl md:text-3xl flex items-center justify-center gap-2 hover:brightness-110 active:scale-[0.98] transition-all shadow-xl shadow-red-500/20 disabled:opacity-70 cursor-pointer"
                                )}
                            >
                                {status === 'processing' ? (
                                    <>
