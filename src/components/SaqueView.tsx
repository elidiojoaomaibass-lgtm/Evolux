        ...
        <div className="px-4 md:px-8 pt-2 md:pt-4 pb-20 space-y-6 md:space-y-8 w-full max-w-none mx-auto transition-all duration-700">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-4 xl:gap-16">
                <div className="space-y-1 md:space-y-3 mt-3 md:mt-2">
                    <h2 className="text-xl md:text-3xl font-black text-emerald-950 dark:text-white tracking-tighter leading-none pl-[3.5rem] md:pl-0 flex items-center gap-3 min-h-[2rem] md:min-h-0">
            ...
            <motion.div
                ...
                className="bg-white dark:bg-brand-900 border border-emerald-100 dark:border-brand-800 rounded-3xl shadow-sm overflow-hidden"
            >
                <div className="p-4 md:p-6 border-b border-emerald-50 dark:border-brand-800 flex items-center justify-between bg-white dark:bg-brand-900/50 backdrop-blur-sm sticky top-0 md:relative">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50 dark:bg-brand-950/50 border-b border-slate-100 dark:border-brand-800">
                                ...
                                <th className="px-6 py-2.5 text-[9px] font-black text-emerald-500 uppercase tracking-widest text-right bg-emerald-50/30">Saldo Disponível</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-50 dark:divide-brand-800">
                            {[
                                ...
                                <tr key={wallet.id} className="group hover:bg-slate-50/50 dark:hover:bg-brand-800/10 transition-colors">
                                    ...
                                    <td className="px-6 py-3 text-right bg-emerald-50/10 transition-colors group-hover:bg-emerald-50/20">
                        ...
                        <tfoot>
                            <tr className="bg-slate-950 text-white font-black border-t border-emerald-500">
                                <td colSpan={2} className="px-6 py-3 text-xs uppercase tracking-[0.2em] text-emerald-400">Saldos Globais</td>
                                ...
                                <td className="px-6 py-3 text-right text-base bg-emerald-900 shadow-inner">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1">
                    <motion.div
                        ...
                        className="bg-white dark:bg-brand-900 border border-emerald-100 dark:border-brand-800 p-6 rounded-3xl shadow-sm h-full"
                    >
                        ...
                        <form onSubmit={handleWithdraw} className="space-y-6">
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                method === m.id
                                                    ? "border-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 shadow-inner"
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-brand-950 border border-emerald-50 dark:border-brand-800 rounded-2xl text-sm font-black outline-none focus:ring-4 focus:ring-emerald-500/10 transition-all dark:text-white"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder="0,00"
                                        className="w-full px-6 py-4 bg-slate-50 dark:bg-brand-950 border border-emerald-50 dark:border-brand-800 rounded-2xl text-2xl font-black outline-none focus:ring-4 focus:ring-emerald-500/10 transition-all dark:text-white"
                                    />
                                ...
                                <button
                                    ...
                                    className="text-[9px] font-black text-emerald-600 dark:text-brand-400 uppercase tracking-[0.1em] hover:underline ml-1"
                                >
                            ...
                            {pendingByWallet[method] ? (
                                ...
                                <div className="bg-slate-50 dark:bg-brand-950 p-4 rounded-2xl border border-emerald-50 dark:border-brand-800 space-y-3">
                                    ...
                                    <div className="flex justify-between items-center text-base font-black text-slate-900 dark:text-white pt-2.5 border-t border-slate-200/50 dark:border-brand-800">
                                        ...
                                        <div className="text-right">
                                            <p className="text-emerald-600">{amount ? parseFloat(amount).toLocaleString('pt-PT') : '0,00'} MZN</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                ...
                <div className="lg:col-span-3 space-y-6">
                    <div className="bg-white dark:bg-brand-900 border border-emerald-100 dark:border-brand-800 rounded-3xl shadow-sm overflow-hidden h-fit">
                        <div className="p-4 md:p-6 border-b border-emerald-50 dark:border-brand-800 flex items-center justify-between">
                            <div>
                                <h3 className="text-base font-black text-slate-900 dark:text-white flex items-center gap-2">
                            ...
                            <button className="text-[9px] font-black text-slate-400 uppercase tracking-widest hover:text-emerald-600 transition-colors border border-slate-100 dark:border-brand-800 px-3 py-1.5 rounded-lg">CSV</button>
                        </div>
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody className="divide-y divide-slate-50 dark:divide-brand-800">
                                    ...
                                    {withdrawalHistory.map((w) => (
                                        <tr key={w.id} className="hover:bg-emerald-50/10 dark:hover:bg-brand-800/10 transition-all group">
                                            <td className="px-6 py-2.5">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-8 w-8 bg-slate-100 dark:bg-brand-950 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-emerald-600 group-hover:text-white transition-all shadow-sm">
                ...
                {showSuccess && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md">
                        <motion.div
                            ...
                            className="bg-white dark:bg-brand-900 w-full max-w-sm rounded-[3rem] p-10 text-center shadow-2xl border border-emerald-100 dark:border-brand-800"
                        >
